	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert (appdata v)
			{
				...
				o.debugExpand = weight_expand.rrrr;
				float weight_combined = weight_expand;
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				// return fixed4(1.0 - (i.uv.y - _Grow), 1.0 - (i.uv.y - _Grow), 1.0 - (i.uv.y - _Grow), 1);
				// return i.debugExpand;
				return col;
			}
